"""Recent panel — live gamelog viewer with session grouping and line filters."""
...
def _parse_sessions(text: str) -> list[list[str]]:
...
class RecentPanel(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        subtitle = QLabel("Latest game session log entries")
    ...
    def _load_and_render(self) -> None:
        ...
        self._sessions = _parse_sessions(text)
        self._render()
